package pickapath;
	...
	public class Main_cli extends JFrame {
		...
		public Main_cli(Main Main_cli) { //I had to change this line to make line 197 happy
			...
			frame.add(panel);
			Canvas canvas = new Canvas(arrows, boxes, Main_cli);  //this line was unhappy after copying it to main_cli
